...
public class ModifiedAutoPolicy {
    ...
    // (Section5.9) to create a compound condition in an if…else statement that compares the method’s
    ...
    public void setState(String state) {
        ...
        if (state=="CT"||state=="MA"||state=="ME"||state=="NH"||state=="NJ"||state=="NY"||state=="PA"||state=="VT"){
            ...
            System.err.println("The State code is wrong. Enter the correct state code!");
        }
