...
public class CrapGameModification2 {
...
e) Do the chances of winning improve with the length of the game?
         */
        int wonAtFirstRoll=0;
        int lossAtFirstRoll=0;
        int j=0;
        ...
        System.out.println("Number of games won at first trow is "+wonAtFirstRoll);
        System.out.println("Number of games loss at first trow is "+lossAtFirstRoll);
        System.out.println("Numbers of games played by point is "+j);
    }
